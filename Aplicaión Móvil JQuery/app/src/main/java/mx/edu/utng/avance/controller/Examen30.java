...
public class Examen30 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen30);
    ...
    private void initComponents(){
        ...
        chkValues= (CheckBox) findViewById(R.id.checkValues);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen30.this, SpinnerExampleActivity.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    } else if (chkValues.isChecked()) {
                        Toast toast = Toast.makeText(this, "Incorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,6,30,resultadoCheck);
                    ...
                    if(registros==0){
                        ...
                        if(aciertos>=4){
                            ...
                            toast.show();
                            Intent intentografica = new Intent(this, GraphAChartEngineActivity5.class);
