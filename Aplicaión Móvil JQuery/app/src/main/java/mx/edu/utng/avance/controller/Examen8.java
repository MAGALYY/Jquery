...
public class Examen8 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkCadena;
    private CheckBox chkSeleccionar;
    private CheckBox chkSeleccion;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen8);
    ...
    private void initComponents(){
        ...
        chkCadena = (CheckBox) findViewById(R.id.checkCadena);
        chkSeleccionar = (CheckBox) findViewById(R.id.checkSeleccionar);
        chkSeleccion = (CheckBox) findViewById(R.id.checkSeleccion);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen8.this, Examen9.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkCadena.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }else if (chkSeleccionar.isChecked()) {
                        //chkBiblio.setText("Checkbox marcado!");
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen8.this, Examen9.class);
                        startActivity(intento);
                        finish();
                    } else if (chkSeleccion.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,2,8,resultadoCheck);
