...
public class Examen11 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkClick;
    private CheckBox chkClicked;
    private CheckBox chkFocus;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen11);
    ...
    private void initComponents(){
        ...
        chkClick = (CheckBox) findViewById(R.id.checkClick);
        chkClicked = (CheckBox) findViewById(R.id.checkClicked);
        chkFocus= (CheckBox) findViewById(R.id.checkFocus);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen11.this, Examen12.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkClick.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck = true;
                        Intent intento = new Intent(Examen11.this, Examen12.class);
                        startActivity(intento);
                        finish();
                    }else if (chkClicked.isChecked()) {
                        //chkBiblio.setText("Checkbox marcado!");
                        Toast toast = Toast.makeText(this, "Incorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck= false;
                    } else if (chkFocus.isChecked()) {
                        Toast toast = Toast.makeText(this, "Incorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,3,11,resultadoCheck);
