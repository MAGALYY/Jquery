...
public class Examen12 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen12);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen12.this, Examen13.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if ((edtInventada.getText().toString()).equalsIgnoreCase(respuesta)) {
                        ...
                        toast.show();
                        Intent intento = new Intent(Examen12.this, Examen13.class);
                    ...
                    respuestaExamen = new RespuestaExamen(1,3,12,resultado);
