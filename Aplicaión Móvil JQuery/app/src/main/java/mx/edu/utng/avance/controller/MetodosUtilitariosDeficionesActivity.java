...
public class MetodosUtilitariosDeficionesActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {//Método onCreate
        ...
        setContentView(R.layout.metodos_utilitarios_definiciones);//Da al contenido de la ventana el valor del layout
    ...
    private void initComponents() {//Método inicializar componentes
        ...
        botonExamen = (Button) findViewById(R.id.btn_examen);//Inicialización tipo botón con id btn_examen
    ...
    public void onClick(View v) {//Método onclick
        ...
        switch (v.getId()){//Sentencia de decisión
            ...
            case R.id.btn_examen:
                Intent i=new Intent(this,   Examen21.class);
