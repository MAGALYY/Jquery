...
public class Juego1 extends Activity implements View.OnClickListener {
    ...
    private String respuesta = "ry";


    @Override
    public void onCreate(Bundle savedInstanceState) {//Método onCreate
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_layout_1);//Da al contenido de la ventana el valor del layout
        ...
        switch (v.getId()) {//Sentencia de decisión
            ...
            case R.id.btnAceptar:
                ...
                if ((edtInventada.getText().toString()).equalsIgnoreCase(respuesta)) {
                    ...
                    toast.show();
                    Intent intento = new Intent(Juego1.this, Juego2.class);
            ...
            case R.id.btnSiguiente:
                Intent i = new Intent(Juego1.this, Juego2.class);
                startActivity(i);
                finish();
                break;
            case R.id.btnRegresar:
                Intent in = new Intent(Juego1.this, MyMenu.class);
                startActivity(in);
                finish();
                break;
