...
public class Examen24 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen24);
    ...
    private void initComponents(){
        ...
        chkTrim = (CheckBox) findViewById(R.id.checkTrim);
        chkEach= (CheckBox) findViewById(R.id.checkEach);
        chkProxy = (CheckBox) findViewById(R.id.checkProxy);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen24.this, Examen25.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkTrim.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= false;
                    } else if (chkProxy.isChecked()) {
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = true;
                        Intent intento = new Intent(Examen24.this, Examen25.class);
                        startActivity(intento);
                        finish();
                    }
                    respuestaExamen = new RespuestaExamen(1,5,24,resultadoCheck);
