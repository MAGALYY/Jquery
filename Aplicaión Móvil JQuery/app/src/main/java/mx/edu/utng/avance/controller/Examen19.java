...
public class Examen19 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkNext;
    private CheckBox chkClosest;
    private CheckBox chkSiblingss;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen19);
    ...
    private void initComponents(){
        ...
        chkSiblingss = (CheckBox) findViewById(R.id.checkSiblings);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen19.this, Examen20.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkNext.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen19.this, Examen20.class);
                        startActivity(intento);
                        finish();
                    } else if (chkSiblingss.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,4,19,resultadoCheck);
