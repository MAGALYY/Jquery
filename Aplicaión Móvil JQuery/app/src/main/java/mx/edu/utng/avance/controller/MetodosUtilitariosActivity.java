...
public class MetodosUtilitariosActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {//Método onCreate
        ...
        setContentView(R.layout.metodos_utilitarios);//Da al contenido de la ventana el valor del layout
    ...
    public void onClick(View v) {//Método onclick
        ...
        switch (v.getId()){//Sentencia de decisión
            ...
            case R.id.btnSiguiente:
                Intent i=new Intent(this,   MetodosUtilitariosDeficionesActivity.class);
