...
public class Examen21 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen21);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen21.this, Examen22.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkFn.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen21.this, Examen22.class);
                    ...
                    respuestaExamen = new RespuestaExamen(1,5,21,resultadoCheck);
