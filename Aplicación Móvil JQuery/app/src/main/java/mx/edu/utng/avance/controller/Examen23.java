...
public class Examen23 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen23);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen23.this, Examen24.class);
                    startActivity(i);
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkN.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen23.this, Examen24.class);
                        startActivity(intento);
                        finish();
                    } else if (chkFn.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,5,23,resultadoCheck);
