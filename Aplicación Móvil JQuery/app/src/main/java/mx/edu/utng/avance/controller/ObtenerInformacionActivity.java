...
public class ObtenerInformacionActivity extends Activity implements View.OnClickListener{
...
private ImageButton imgButton2;
    ...
    protected void onCreate(Bundle savedInstanceState) {//Método onCreate
        ...
        setContentView(R.layout.obtener_informacion);//Da al contenido de la ventana el valor del layout
        ...
        private void initComponents() {//Método inicializar componentes
            ...
            botonSiguiente = (Button) findViewById(R.id.btnSiguiente);//Inicialización tipo botón con id btnSiguiente
            botonSiguiente.setOnClickListener(this);
            imgButton1 = (ImageButton) findViewById(R.id.img_button1);//Inicialización tipo botón imagen con id img_button1
    ...
    public void onClick(View v) {//Método onclick
        ...
        switch (v.getId()){//Sentencia de decisión
            ...
            case R.id.btnSiguiente:
                Intent i=new Intent(this,   InformacionElementosActivity.class);
