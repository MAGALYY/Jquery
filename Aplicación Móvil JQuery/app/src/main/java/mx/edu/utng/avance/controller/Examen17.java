...
public class Examen17 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkChildren;
    private CheckBox chkParent;
    private CheckBox chkParents;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen17);
    ...
    private void initComponents(){
        ...
        chkParents = (CheckBox) findViewById(R.id.checkParents);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen17.this, Examen18.class);
                    startActivity(i);
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkChildren.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen17.this, Examen18.class);
                    ...
                    respuestaExamen = new RespuestaExamen(1,4,17,resultadoCheck);
