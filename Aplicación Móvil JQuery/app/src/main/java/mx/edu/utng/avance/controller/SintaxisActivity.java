...
public class SintaxisActivity extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {//Método onCreate
        ...
        setContentView(R.layout.sintaxis);//Da al contenido de la ventana el valor del layout
    ...
    public void onClick(View v) {//Método onclick
        switch (v.getId()) {//Sentencia de decisión
            ...
            case R.id.btn_examen:
                Intent i = new Intent(SintaxisActivity.this, Examen6.class);
            ...
            case R.id.img_button1:
                Intent intento = new Intent(SintaxisActivity.this, SpinnerExampleActivity.class);
