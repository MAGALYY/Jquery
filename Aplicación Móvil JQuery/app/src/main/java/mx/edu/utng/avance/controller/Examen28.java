...
public class Examen28 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen28);
    ...
    private void initComponents(){
        ...
        chkHeight = (CheckBox) findViewById(R.id.checkHeight);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen28.this, Examen29.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkAttr.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= false;
                    } else if (chkHeight.isChecked()) {
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = true;
                        Intent intento = new Intent(Examen28.this, Examen29.class);
                        startActivity(intento);
                        finish();
                    }
                    respuestaExamen = new RespuestaExamen(1,6,28,resultadoCheck);
