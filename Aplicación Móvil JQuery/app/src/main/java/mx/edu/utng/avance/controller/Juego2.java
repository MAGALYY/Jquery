...
public class Juego2 extends Activity implements View.OnClickListener {
    ...
    private String respuesta = "DR";


    @Override
    public void onCreate(Bundle savedInstanceState) {//Método onCreate
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_layout_2);//Da al contenido de la ventana el valor del layout
        ...
        switch (v.getId()) {//Sentencia de decisión
            ...
            case R.id.btnAceptar:
                ...
                if ((edtInventada.getText().toString()).equalsIgnoreCase(respuesta)) {
                    ...
                    toast.show();
                    Intent intento = new Intent(Juego2.this, Juego3.class);
            ...
            case R.id.btnSiguiente:
                Intent i = new Intent(Juego2.this, Juego3.class);
                startActivity(i);
                finish();
                break;
            case R.id.btnRegresar:
                Intent in = new Intent(Juego2.this, Juego1.class);
                startActivity(in);
                finish();
                break;
