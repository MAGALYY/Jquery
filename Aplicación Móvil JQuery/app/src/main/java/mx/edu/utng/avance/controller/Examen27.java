...
public class Examen27 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen27);
    ...
    private void initComponents(){
        ...
        chkCss = (CheckBox) findViewById(R.id.checkCss);
        chkHtml = (CheckBox) findViewById(R.id.checkHtml);
        chkTxt = (CheckBox) findViewById(R.id.checkTxt);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen27.this, Examen28.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkCss.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen27.this, Examen28.class);
                        startActivity(intento);
                        finish();
                    } else if (chkTxt.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,6,27,resultadoCheck);
