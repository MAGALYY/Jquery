...
public class VincularEventosActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {//Método onCreate
        ...
        setContentView(R.layout.vincular_eventos);//Da al contenido de la ventana el valor del layout
        initComponents();//Implementando método initComponents

    }
    private void initComponents() {//Método inicializar componentes

        botonSiguiente = (Button) findViewById(R.id.btnSiguiente);//Declaración tipo botón con id btnSiguiente
    ...
    public void onClick(View v) {//Método onclick
        ...
        switch (v.getId()){//Sentencia de decisión
            ...
            case R.id.btnSiguiente:
                Intent i=new Intent(this,   TipoMetodoActivity.class);
