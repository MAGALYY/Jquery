...
public class Examen20 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkNext;
    private CheckBox chkClosest;
    private CheckBox chkNextt;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen20);
    ...
    private void initComponents(){
        ...
        chkNext = (CheckBox) findViewById(R.id.checkNext);
        chkClosest = (CheckBox) findViewById(R.id.checkClosest);
        chkNextt = (CheckBox) findViewById(R.id.checkNextt);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen20.this, SpinnerExampleActivity.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if(registros==0){
                        ...
                        if(aciertos>=4){
                            ...
                            toast.show();
                            Intent intentografica = new Intent(this, GraphAChartEngineActivity3.class);
