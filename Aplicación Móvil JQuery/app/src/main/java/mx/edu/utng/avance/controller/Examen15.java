...
public class Examen15 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkReducir;
    private CheckBox chkProveer;
    private CheckBox chkPractica;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen15);
    ...
    private void initComponents(){
        ...
        chkReducir = (CheckBox) findViewById(R.id.checkReducir);
        chkProveer = (CheckBox) findViewById(R.id.checkProveer);
        chkPractica = (CheckBox) findViewById(R.id.checkPractica);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen15.this, SpinnerExampleActivity.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if(registros==0){
                        ...
                        int aciertos = dao.obtenerResultados3(db, estado);
                        Log.d("Aciertos ", " " + aciertos);
                        if(aciertos>=4){
                            Toast toast = Toast.makeText(this, "Examen Aprobado", Toast.LENGTH_SHORT);
                            toast.show();
                            Intent intentografica = new Intent(this, GraphAChartEngineActivity2.class);
