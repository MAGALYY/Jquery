...
public class MetodosRecorridoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {//Método onCreate
        ...
        setContentView(R.layout.metodos_recorrido);//Da al contenido de la ventana el valor del layout
    ...
    public void onClick(View v) {//Método onclick
        ...
        switch (v.getId()){//Sentencia de decisión
            ...
            case R.id.btn_examen:
                Intent i=new Intent(this,   Examen16.class);
