...
public class Examen14 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkFnClick;
    private CheckBox chkFnFocus;
    private CheckBox chkFnBlur;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen14);
    ...
    private void initComponents(){
        ...
        chkFnClick = (CheckBox) findViewById(R.id.checkFnClick);
        chkFnFocus = (CheckBox) findViewById(R.id.checkFnFocus);
        chkFnBlur = (CheckBox) findViewById(R.id.checkFnBlur);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen14.this, Examen15.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkFnClick.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }else if (chkFnFocus.isChecked()) {
                        //chkBiblio.setText("Checkbox marcado!");
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck= false;
                    } else if (chkFnBlur.isChecked()) {
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = true;
                        Intent intento = new Intent(Examen14.this, Examen15.class);
                        startActivity(intento);
                        finish();
                    }
                    respuestaExamen = new RespuestaExamen(1,3,14,resultadoCheck);
