...
public class VideoDomActivity extends Activity {


    Button viewVideoButton = null;
    public String videoId = "SfWbj8mA-TI";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_dom_layout);
        ...
        viewVideoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View pV) {
                ...
                Intent lVideoIntent = new Intent(null, Uri.parse("ytv://" + videoId), VideoDomActivity.this, OpenYouTubePlayerActivity.class);
