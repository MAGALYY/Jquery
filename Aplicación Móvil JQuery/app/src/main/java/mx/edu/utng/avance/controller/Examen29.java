...
public class Examen29 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkVal;
    private CheckBox chkPosition;
    private CheckBox chkPositionns;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen29);
    ...
    private void initComponents(){
        ...
        chkVal = (CheckBox) findViewById(R.id.checkVal);
        chkPosition = (CheckBox) findViewById(R.id.checkPosition);
        chkPositionns = (CheckBox) findViewById(R.id.checkPositionns);
        dbHelper = new DBHelper(this,DBHelper.DATABASE_NAME,null,DBHelper.DATABASE_VERSION);
        db = dbHelper.getWritableDatabase();
        dao = new RespuestaExamenDAOImpl(); if(estado == "inactivo"){
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen29.this, Examen30.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    }else if (chkPosition.isChecked()) {
                        //chkBiblio.setText("Checkbox marcado!");
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck= true;
                        Intent intento = new Intent(Examen29.this, Examen30.class);
                        startActivity(intento);
                        finish();
                    } else if (chkPositionns.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,6,29,resultadoCheck);
