...
public class Examen7 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkAplicacion;
    private CheckBox chkUsuario;
    private CheckBox chkPreciso;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen7);
    ...
    private void initComponents(){
        ...
        chkAplicacion = (CheckBox) findViewById(R.id.checkAplicacion);
        chkUsuario = (CheckBox) findViewById(R.id.checkUsuario);
        chkPreciso = (CheckBox) findViewById(R.id.checkPreciso);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen7.this, Examen8.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkAplicacion.isChecked()) {
                        ...
                        toast.show();
                        resultadoCheck= false;
                    } else if (chkPreciso.isChecked()) {
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = true;
                        Intent intento = new Intent(Examen7.this, Examen8.class);
                        startActivity(intento);
                        finish();
                    }
                    respuestaExamen = new RespuestaExamen(1,2,7,resultadoCheck);
