...
public class Examen18 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkChildren;
    private CheckBox chkSiblings;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen18);
    ...
    private void initComponents(){
        ...
        chkChildren = (CheckBox) findViewById(R.id.checkChildren);
        chkSiblings = (CheckBox) findViewById(R.id.checkSiblings);
        chkParent = (CheckBox) findViewById(R.id.checkParent);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen18.this, Examen19.class);
                    startActivity(i);
                    finish();
                    break;
                case R.id.btnAceptar:
                    ...
                    if (chkChildren.isChecked()) {
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = true;
                        Intent intento = new Intent(Examen18.this, Examen19.class);
                        startActivity(intento);
                        finish();
                    }else if (chkSiblings.isChecked()) {
                    ...
                    respuestaExamen = new RespuestaExamen(1,4,18,resultadoCheck);
