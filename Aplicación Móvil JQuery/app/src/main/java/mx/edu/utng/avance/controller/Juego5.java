...
public class Juego5 extends Activity implements View.OnClickListener {
    ...
    private String respuesta = "JA";


    @Override
    public void onCreate(Bundle savedInstanceState) {//Método onCreate
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_layout_5);//Da al contenido de la ventana el valor del layout
        ...
        switch (v.getId()) {//Sentencia de decisión
            ...
            case R.id.btnAceptar:
                ...
                if ((edtInventada.getText().toString()).equalsIgnoreCase(respuesta)) {
                    ...
                    toast.show();
                    Intent intento = new Intent(Juego5.this, AcertoActivity.class);
            ...
            case R.id.btnSiguiente:
                Intent i = new Intent(Juego5.this, MyMenu.class);
                startActivity(i);
                finish();
                break;
            case R.id.btnRegresar:
                Intent in = new Intent(Juego5.this,Juego4.class);
                startActivity(in);
                finish();
                break;
