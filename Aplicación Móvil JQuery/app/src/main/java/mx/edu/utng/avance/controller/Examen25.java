...
public class Examen25 extends Activity implements View.OnClickListener {
    private Button botonAceptar;
    private Button botonSiguiente;
    private CheckBox chkArray;
    private CheckBox chkExtend;
    private CheckBox chkEach;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examen25);
    ...
    private void initComponents(){
        ...
        chkArray = (CheckBox) findViewById(R.id.checkArray);
        chkExtend = (CheckBox) findViewById(R.id.checkExtend);
        chkEach = (CheckBox) findViewById(R.id.checkEach);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnSiguiente:
                    Intent i = new Intent(Examen25.this, SpinnerExampleActivity.class);
                    startActivity(i);
                    break;
                case R.id.btnAceptar:
                    ...
                    }else if (chkExtend.isChecked()) {
                        //chkBiblio.setText("Checkbox marcado!");
                        Toast toast = Toast.makeText(this, "Correcto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck= true;

                    } else if (chkEach.isChecked()) {
                        Toast toast = Toast.makeText(this, "InCorrecto", Toast.LENGTH_SHORT);
                        toast.show();
                        resultadoCheck = false;
                    }
                    respuestaExamen = new RespuestaExamen(1,5,25,resultadoCheck);
                    ...
                    if(registros==0){
                        ...
                        int aciertos = dao.obtenerResultados5(db, estado);
                        Log.d("Aciertos ", " " + aciertos);
                        if(aciertos>=4){
                            Toast toast = Toast.makeText(this, "Examen Aprobado", Toast.LENGTH_SHORT);
                            toast.show();
                            Intent intentografica = new Intent(this, GraphAChartEngineActivity4.class);
